    ...
    <StyledContainer>
      <StyledFlex>
        <StyledTextContainer>
          ...
          <Title as="h2" mt="15px" mb="15px" color="white" fontFamily="Montserrat" size="lg" fontWeight={700}>
            {TranslateString(592, 'What is it good for?')}
          </Title>
          <Title color="white" fontFamily="Montserrat" size="md" mb="12px" fontWeight={500}>
          ...
          <Title color="white" fontFamily="Montserrat" size="md" mb="12px" mt="12px" fontWeight={500}>
