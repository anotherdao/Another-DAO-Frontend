        ...
        <Cards>
          ...
          <StyledCard>
            ...
            <StyledTextContainer>
              ...
              <Title as="h2" mt="15px" mb="15px" fontFamily="Montserrat" size="sm">
                {TranslateString(592, 'How To Take Part')}
              </Title>
              <Title fontFamily="Montserrat" fontWeight={700}>
                {TranslateString(594, 'Before Sale')}
              </Title>
              <List>
                <Text fontFamily="Montserrat">{TranslateString(596, 'Be ready to pay a 30% fee to buy GNANA')}</Text>
                <Text fontFamily="Montserrat">{TranslateString(598, 'Purchase GNANA using BANANA')}</Text>
              </List>
              <Text fontSize="10px" fontFamily="Montserrat">
                * Remember buying GNANA means you lose 30% of your BANANA when making the purchase
              </Text>
              <Title fontFamily="Montserrat" fontWeight={700} mt="15px">
              ...
              <List>
                ...
                <Text fontFamily="Montserrat">{TranslateString(608, 'Done!')}</Text>
                <Text fontSize="10px" fontFamily="Montserrat">
