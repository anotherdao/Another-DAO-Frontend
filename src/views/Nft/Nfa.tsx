      ...
      <PageHolder>
        ...
        <DetailsHolder>
          <BoxShadow>
            ...
            <Text fontFamily="Montserrat" fontSize="20px" color="textSubtle" style={{ margin: '5px 0px 5px 0px' }}>
              {TranslateString(
                999,
          ...
          {sales && (
            <BoxShadow style={{ marginTop: '25px', padding: '5px 0px 10px 0px' }}>
              <Text fontFamily="Montserrat" fontSize="23px" color="textSubtle" style={{ margin: '10px 0px 15px 0px' }}>
