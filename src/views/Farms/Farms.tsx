...
import { Heading, RowType, Text, Card, Checkbox, ArrowDropDownIcon, Toggle } from '@apeswapfinance/uikit'
...
const Header = styled.div`
  ...
  // background-image:url('../../../images/wineswap-img.ac45b0d6.png');
...
const Farms: React.FC = () => {
  ...
  return (
    <>
      ...
      <Header>
        <HeadingContainer>
          <StyledHeading as="h1" mb="12px" mt={0} fontWeight={700}>
            {/* {TranslateString(999, 'Stake LP tokens to earn BANANA')} */}
            Oak Barrel
          </StyledHeading>

          <StyledSubHeading>{t('Stake LP tokens to earn')}</StyledSubHeading>
        </HeadingContainer>
      </Header>
          ...
          <ViewControls>
            ...
            <ButtonCheckWrapper>
              <ToggleWrapper onClick={() => setStakedOnly(!stakedOnly)}>
                <Toggle sizes="sm" checked={stakedOnly} onChange={() => setStakedOnly(!stakedOnly)} />
