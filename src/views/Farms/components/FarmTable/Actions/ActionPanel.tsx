...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({
 ...
 const { t } = useTranslation();
  ...
  const bsc =
    chainId === 97 ? `https://testnet.bscscan.com/address/${lpAddress}` : `https://bscscan.com/address/${lpAddress}`
      ...
      <Container>
        <Flex>
          <InfoContainer liquidityDigits={liquidityDigits}>
            <ValueContainer>
              <ValueWrapper>
                <StyledText fontFamily="Montserrat" fontSize="12px">
                  {t('Multiplier')}:
                </StyledText>
            ...
            <ValueContainer>
              <ValueWrapper>
                ...
                <LinkExternal className="noClick" href={addLiquidityUrl}>
                  <StyledText className="noClick" fontFamily="Montserrat" fontSize="12px">
                    {farm.lpSymbol}
                  </StyledText>
                </LinkExternal>
              </ValueWrapper>
              <ValueWrapper>
                ...
                <StyledText fontFamily="Montserrat" fontSize="12px" color="primary">
          ...
          <Flex flexDirection="column">
            {account && rawStakedBalance !== 0 && (
              <>
                <StakedText fontFamily="Montserrat" fontSize="12px">
                  {t('Staked')}
                </StakedText>
