...
const ifos: Ifo[] = [
  ...
  {
    id: 'reward3',
    address: '0x614e4B268bE172D6D2fc4C6a1241B1e451137778', // Leave empty for "Coming Soon!"
    isActive: false,
    isLinear: false,
    name: 'Reward3',
    subTitle: `The next reward token`,
    description: `This is reward token for example IFO.`,
    launchDate: '11 Feb 2022',
    launchTime: '5:00 UTC',
    saleAmount: '100 REWARD3',
    raiseAmount: '$100',
    vestingTime: '1 Day',
    projectSiteUrl: 'https://99starz.io/',
    currency: 'CORK',
    currencyAddress: '0xEB7eeAe7F80915E046dCB4d819BE1Ec0A7799173',
    offeringCurrency: 'reward3',
    tokenDecimals: 18,
    releaseBlockNumber: 16626426, // block to start showing contract details
    vesting: true,
    // burnedTxUrl: '',
  },
  {
    id: 'reward2',
    address: '0x081841C5eB0d4B87756d8739B13b3b840d62D566', // Leave empty for "Coming Soon!"
    isActive: true,
    isLinear: false,
    name: '99Starz',
    ...
    launchTime: '5:00 UTC',
    saleAmount: '80,000,000 REWARD2',
    raiseAmount: '$400,000',
    vestingTime: '3 Months',
    projectSiteUrl: 'https://99starz.io/',
    currency: 'WBNB',
    currencyAddress: '0x0000000000000000000000000000000000000000',
    offeringCurrency: 'reward2',
    tokenDecimals: 18,
    releaseBlockNumber: 16626426, // block to start showing contract details
    vesting: true,
    // burnedTxUrl: '',
