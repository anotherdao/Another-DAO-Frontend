...
export const BANANA_PER_BLOCK = new BigNumber(0.01)
...
export const BANANA_POOL_PID = 4
export const BASE_EXCHANGE_URL = 'https://deploydex.web.app/#'
export const BASE_ADD_LIQUIDITY_URL = `${BASE_EXCHANGE_URL}/trade/swap`
export const BASE_LIQUIDITY_POOL_URL = `${BASE_EXCHANGE_URL}/trade/pool`
